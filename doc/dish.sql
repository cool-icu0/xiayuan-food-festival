drop database if exists `take_out_dish`;
create database `take_out_dish`;
use `take_out_dish`;
...
(
    ...
    `category_id` varchar(32)                   NOT NULL COMMENT '菜品分类id',
...
(
    `id`          varchar(32)                  NOT NULL COMMENT '主键',
    `dish_id`     varchar(32)                  NOT NULL COMMENT '菜品',
